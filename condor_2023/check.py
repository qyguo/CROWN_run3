...
dy_file = '/afs/cern.ch/user/j/jiahua/CROWN_run3/condor_2023/Sample_list/ZZto4L_powheg_22_ext1-v2.txt'  # DY.txt 文件路径
folder_path = '/afs/cern.ch/user/j/jiahua/work/MC_2023_inc/ZZto4L_powheg_22_ext1-v2'  # 包含 .root 文件的文件夹路径
log_path = '/afs/cern.ch/user/j/jiahua/work/MC_2023_inc/log/log_ZZto4L_powheg_22_ext1-v2'  # 输出未找到条目的文件
