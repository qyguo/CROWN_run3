// Orignal author: Aleko Khukhunaishvili
// Author: Hyon-San Seo (from Run3.v1)
...
class RoccoR{
	...
	struct CorParams{
	    ...
	    double X;
	    double E;
	    CorParams():M(1),A(0),X(0),E(0){}
	    double k(int Q, double pt) const{
		return 1.0/(M + Q*A*pt + X/pt)+E/pt;
	    }
	};
