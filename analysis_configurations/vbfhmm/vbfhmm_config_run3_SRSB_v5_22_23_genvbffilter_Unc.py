    ...
    configuration.add_config_parameters(
        ["global","gghmm","vbfhmm","e2m","m2m","eemm","mmmm","nnmm","fjmm","nnmm_dycontrol","nnmm_topcontrol"],
        {
            ...
            "muon_KIT_files": EraModifier(
                {
                    "2022": "data/jsonpog-integration/POG/MUO/2022_Summer22/muon_scalesmearing_VXBS.json.gz",
                    "2022EE": "data/jsonpog-integration/POG/MUO/2022_Summer22EE/muon_scalesmearing_VXBS.json.gz",
                    "2023": "data/jsonpog-integration/POG/MUO/2023_Summer23/muon_scalesmearing_VXBS.json.gz",
                    "2023BPix": "data/jsonpog-integration/POG/MUO/2023_Summer23BPix/muon_scalesmearing_VXBS.json.gz",
    ...
    configuration.add_config_parameters(
        "global",
        {
            ...
            "jet_jer_tag": EraModifier(
                {
                    ...
                    "2022": '"Summer22_22Sep2023_JRV2_MC"',
                    "2022EE": '"Summer22EE_22Sep2023_JRV2_MC"',
                    "2023": '"Summer23Prompt23_RunCv1234_JRV2_MC"',
                    "2023BPix": '"Summer23BPixPrompt23_RunD_JRV2_MC"',
            ...
            "jet_jes_tag_data":EraModifier(
                {
                    "2022": '"Summer22_22Sep2023_V4_DATA"',
                    "2022EE": '"Summer22EE_22Sep2023_V4_DATA"',
                    "2023": '"Summer23Prompt23_V4_DATA"',
                    "2023BPix": '"Summer23BPixPrompt23_V4_DATA"',
            ...
            "jet_jes_tag": EraModifier(
                {
                    ...
                    "2022": '"Summer22_22Sep2023_V4_MC"',
                    "2022EE": '"Summer22EE_22Sep2023_V4_MC"',
                    "2023": '"Summer23Prompt23_V4_MC"',
                    "2023BPix": '"Summer23BPixPrompt23_V4_MC"',
                    #"2024": '"Summer24Prompt24_V1_MC"',
            ...
            "btag_corr_algo": EraModifier(
                {
                    ...
                    "2017": "deepCSV_comb",
                    "2018": "deepCSV_comb",
                    "2022": "particleNet_shape",
                    "2022EE": "particleNet_shape",
                    # no particleNet_comb yet 2025 Mar 10
                    # no using the BtagSF
                    "2023": "particleNet_shape",
                    "2023BPix": "particleNet_shape",
