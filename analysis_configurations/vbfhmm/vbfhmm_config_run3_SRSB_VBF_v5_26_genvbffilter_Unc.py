...
#https://cms-analysis-corrections.docs.cern.ch/corrections_era/Run3-24CDEReprocessingFGHIPrompt-Summer24-NanoAODv15/MUO/2025-10-17/#muon_highptjsongz
...
def build_config(
            ...
            "PU_reweighting_file_hist": EraModifier(
                {
                    ...
                    #"2024":"",
                    "2024": "data/pileup/dataPileupHistogram-2024BCDEFGHI-69200ub.root",
                    "2025": "data/pileup/dataPileupHistogram-2025pp_Golden-69200ub.root",
                    "2026": "data/pileup/dataPileupHistogram-2025pp_Golden-69200ub.root",
                }
            ),
            ...
            "PU_reweighting_file": EraModifier(
                {
                    ...
                    "2025":"data/jsonpog-integration/POG/LUM/2025_Summer25/puWeights_2025pp_Golden_Summer24_25ns_69200ub.json.gz",
                    "2026":"data/jsonpog-integration/POG/LUM/2025_Summer25/puWeights_2025pp_Golden_Summer24_25ns_69200ub.json.gz",
                }
            ),
            ...
            "muon_RoccoR_files": EraModifier(
                {
                    ...
                    "2024": "data/RoccoR_files/RoccoR2023BPix.txt",
                    "2025": "data/RoccoR_files/RoccoR2023BPix.txt",
                    "2026": "data/RoccoR_files/RoccoR2023BPix.txt",
                }
            ),
            "muon_KIT_files": EraModifier(
                {
                    "2022": "data/KIT_files/2022_Summer22.json",
                    ...
                    "2025": "data/jsonpog-integration/POG/MUO/2025_Summer25/muon_scalesmearing_VXBS.json.gz",
                    "2026": "data/jsonpog-integration/POG/MUO/2025_Summer25/muon_scalesmearing_VXBS.json.gz",
                }
            ),
        }
    )
            ...
            "ele_id": EraModifier(
                {
                    ...
                    "2024": "Electron_mvaNoIso_WP90",
                    "2025": "Electron_mvaNoIso_WP90",
                    "2026": "Electron_mvaNoIso_WP90",
                }
            ),
        }
    )
            ...
            "muon_sf_file": EraModifier(
                {
                    ...
                    "2025": "data/jsonpog-integration/POG/MUO/2025_Summer25/muon_Z.json.gz",
                    "2026": "data/jsonpog-integration/POG/MUO/2025_Summer25/muon_Z.json.gz",
                }
            ),
            ...
            "muon_iso_sf_name": EraModifier(
                {
                    ...
                    "2026": "NUM_TightPFIso_DEN_MediumID",
                }
            ),
            ...
            "muon_sf_varation": EraModifier(
                {
                    ...
                    "2024": "nominal", # Nominal central scale factor value
                    "2025": "nominal", # Nominal central scale factor value
                    "2026": "nominal", # Nominal central scale factor value
                }
            ),
        },
    )
            ...
            "ele_sf_file": EraModifier(
                {
                    ...
                    "2025": "data/jsonpog-integration/POG/EGM/2025_Summer25/electron.json.gz",
                    "2026": "data/jsonpog-integration/POG/EGM/2025_Summer25/electron.json.gz",
                }
            ),
            ...
            "jet_puid": EraModifier(
                {
                    ...
                    "2024": 4,  # 0==fail, 4==pass(loose), 6==pass(loose,medium), 7==pass(loose,medium,tight)
                    "2025": 4,  # 0==fail, 4==pass(loose), 6==pass(loose,medium), 7==pass(loose,medium,tight)
                    "2026": 4,  # 0==fail, 4==pass(loose), 6==pass(loose,medium), 7==pass(loose,medium,tight)
                }
            ),
            ...
            "jet_jec_file": EraModifier(
                {
                    ...
                    "2024": '"data/jsonpog-integration/POG/JME/2024_Summer24/jet_jerc.json.gz"',
                    "2025": '"data/jsonpog-integration/POG/JME/2025_Summer25/jet_jerc.json.gz"',
                    "2026": '"data/jsonpog-integration/POG/JME/26Prompt_Summer24/jet_jerc.json.gz"',
                }
            ),
            ...
            "jet_veto_map": EraModifier(
                    {
                        ...
                        "2024": '"data/jsonpog-integration/POG/JME/2024_Summer24/jetvetomaps.json.gz"',
                        "2025": '"data/jsonpog-integration/POG/JME/2025_Summer25/jetvetomaps.json.gz"',
                        "2026": '"data/jsonpog-integration/POG/JME/26Prompt_Summer24/jetvetomaps.json.gz"',
                    }
            ),
            ...
            "btag_sf_file": EraModifier(
                {
                    ...
                    "2024": "data/jsonpog-integration/POG/BTV/2024_Summer24/btagging.json.gz",
                    "2025": "data/jsonpog-integration/POG/BTV/2025_Summer25/btagging.json.gz",
                    "2026": "data/jsonpog-integration/POG/BTV/2025_Summer25/btagging.json.gz",
                }
            ),
    ...
    configuration.add_producers(
        ...
        [
            ...
            jets.JetIdTightLepVeto_Cut_v15,
            ...
            jets.GoodJets_2022_JetIdTightLepVeto_v15, # vh overlap removal with ?base? muons done [need validation]
            jets.GoodBJetsLoose, 
...
#
            muons.Muon_pTErr_1,
            muons.Muon_pTErr_2,
            muons.Muon_bsConstrainedChi2_1,
            muons.Muon_bsConstrainedChi2_2,
            muons.Muon_bsConstrainedPt_1,
            muons.Muon_bsConstrainedPt_2,
            muons.Muon_bsConstrainedPtErr_1,
            muons.Muon_bsConstrainedPtErr_2,
    ...
    configuration.add_outputs(
        ...
        [
            ...
            q.mu1_fromH_ptErr,
            q.mu2_fromH_ptErr,
            q.mu1_fromH_bsConstrainedChi2,
            q.mu2_fromH_bsConstrainedChi2,
            q.mu1_fromH_bsConstrainedPt,
            q.mu2_fromH_bsConstrainedPt,
    ...
    # global scope
    if (era == "2022" or era == "2022EE" or era == "2023" or era == "2023BPix") and sample == "data":
        configuration.add_modification_rule(
            "global",
            AppendProducer(
    ...
    if (era == "2025" or era == "2026") and sample == "data":
        configuration.add_modification_rule(
            "global",
            AppendProducer(
                #producers=[jets.JetEnergyCorrection_data_2025, event.JSONFilter,],
                producers=[jets.JetEnergyCorrection_data_2024, event.JSONFilter,],
                samples=["data"],
                update_output=False,
            ),
    ...
    ##########################
    #jer_Region = ["barrel","endcap1","endcap2highpt","endcap2lowpt","forwardhighpt","forwardlowpt"]
    #if sample != "data":
    #    for region in jer_Region:
    #        configuration.add_shift(
    #            SystematicShift(
    #                name=f"jer{region}Up",
    #                shift_config={
    #                    "global": {"jet_jer_shift": '"up"',
    #                               "jer_region_tag": f'"{region}"'}
    #                },
    #                producers={
    #                    "global": [
