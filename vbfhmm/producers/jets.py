...
JetPtCorrection_202223 = Producer(
    name="JetPtCorrection_202223",
    ...
    call="physicsobject::jet::JetPtCorrection_202223({df}, {output}, {input}, {jet_reapplyJES}, {jet_jes_sources}, {jet_jes_shift}, {jet_jer_shift}, {jet_jec_file}, {jet_jer_tag}, {jet_jes_tag}, {jet_jec_algo}, {jet_veto_map}, {jet_veto_tag}, {jer_region_tag})",
    input=[
        nanoAOD.Jet_pt,
        nanoAOD.Jet_eta,
        nanoAOD.Jet_phi,
...
JetEnergyCorrection_202223 = ProducerGroup(
    name="JetEnergyCorrection_202223",
    call=None,
    input=None,
    output=None,
    scopes=["global"],
    subproducers=[JetPtCorrection_202223, JetMassCorrection],
)

# JetPtCorrection_202223_JER = Producer(
#     name="JetPtCorrection_202223_JER",
#     call="physicsobject::jet::JetPtCorrection_202223_JER({df}, {output}, {input}, {jet_reapplyJES}, {jet_jes_sources}, {jet_jes_shift}, {jet_jer_shift}, {jet_jec_file}, {jet_jer_tag}, {jet_jes_tag}, {jet_jec_algo}, {jet_veto_map}, {jet_veto_tag}, {jer_region_tag})",
#     input=[
#         nanoAOD.Jet_pt,
#         nanoAOD.Jet_eta,
#         nanoAOD.Jet_phi,
...
#     scopes=["global"],
# )
# JetPtCorrection_202223_JER.is_shift = True
# JetPtCorrection_202223_JER.base = JetPtCorrection_202223
# JetEnergyCorrection_202223_JER = ProducerGroup(
#     name="JetEnergyCorrection_202223_JER",
#     call=None,
#     input=None,
#     output=None,
#     scopes=["global"],
#     subproducers=[JetPtCorrection_202223_JER, JetMassCorrection],
# )
...
JetPtCorrection_data_2022 = Producer(
    ...
    call="physicsobject::jet::JetPtCorrection_data_2022({df}, {output}, {input}, {jet_run_tag},{jet_jec_file}, {jet_jes_tag_data}, {jet_jec_algo}, {jet_veto_map}, {jet_veto_tag})",
    input=[
        nanoAOD.Jet_pt,
        nanoAOD.Jet_eta,
        nanoAOD.Jet_phi,
...
JetPtCorrection_data_2023BPix = Producer(
    name="JetPtCorrection_data_2023BPix",
    #call="physicsobject::jet::JetPtCorrection_data_2022({df}, {output}, {input}, {jet_reapplyJES}, {jet_jes_sources}, {jet_jes_shift}, {jet_jer_shift}, {jet_jec_file}, {jet_jer_tag}, {jet_jes_tag}, {jet_jec_algo})",
    call="physicsobject::jet::JetPtCorrection_data_2023BPix({df}, {output}, {input}, {jet_run_tag}, {jet_jec_file}, {jet_jes_tag_data}, {jet_jec_algo}, {jet_veto_map}, {jet_veto_tag})",
    input=[
        nanoAOD.Jet_pt,
        nanoAOD.Jet_eta,
        nanoAOD.Jet_phi,
...
##
JetEnergyCorrection_data_2023BPix = ProducerGroup(
    name="JetEnergyCorrection_data_2023BPix",
    call=None,
    input=None,
    output=None,
    scopes=["global"],
    subproducers=[JetPtCorrection_data_2023BPix, JetMassCorrection],
)
...
HornJetVeto = Producer(
    name="HornJetVeto",
    call="physicsobject::jet::VetoHornJet({df}, {output}, {input})",
    input=[nanoAOD.Jet_eta, q.Jet_pt_corrected], # vh base or good muon?
    output=[q.jet_horn_veto_mask],
    scopes=["global", "vbfhmm"],
)

GoodJets_2022_VetoHorn = ProducerGroup(
    name="GoodJets_2022_VetoHorn",
    call="physicsobject::CombineMasks({df}, {output}, {input})",
    input=[],
    output=[q.good_jets_mask],
    scopes=["global", "vbfhmm"],
...
Jet1_btagPNetQvG = Producer(
    name="Jet1_btagPNetQvG",
    call="quantities::ptErr({df}, {output}, 0, {input})",
    input=[q.good_jet_collection, nanoAOD.Jet_btagPNetQvG],
    output=[q.jet1_btagPNetQvG],
    scopes=["global","vbfhmm"],
)
Jet2_btagPNetQvG = Producer(
    name="Jet2_btagPNetQvG",
    call="quantities::ptErr({df}, {output}, 1, {input})",
    input=[q.good_jet_collection, nanoAOD.Jet_btagPNetQvG],
    output=[q.jet2_btagPNetQvG],
    scopes=["global","vbfhmm"],
)
#Jet1_qgl = Producer(
#    name="Jet1_qgl",
...
GoodJetFilter = Filter(
    name="GoodJetFilter",
    call='basefunctions::FilterFlagsAny({df}, "GoodJetsCollection", {input})',
    input=[],
    scopes=["global"],
    subproducers=[GoodJetFlag],
)
##raw jet
Jet1_rawpT = Producer(
    name="Jet1_rawpT",
...
Jet3_rawpT = Producer(
    name="Jet3_rawpT",
    call="basefunctions::getvar<float>({df}, {output}, 2, {input})",
    input=[q.good_jet_collection, nanoAOD.Jet_pt],
    output=[q.jet3_rawpT],
    scopes=["global","vbfhmm"],
)
Jet4_rawpT = Producer(
    name="Jet4_rawpT",
    call="basefunctions::getvar<float>({df}, {output}, 3, {input})",
    input=[q.good_jet_collection, nanoAOD.Jet_pt],
    output=[q.jet4_rawpT],
    scopes=["global","vbfhmm"],
)
...
Jet3_rawMass = Producer(
    name="Jet3_rawMass",
    call="basefunctions::getvar<float>({df}, {output}, 2, {input})",
    input=[q.good_jet_collection, nanoAOD.Jet_mass],
    output=[q.jet3_rawMass],
    scopes=["global","vbfhmm"],
)
Jet4_rawMass = Producer(
    name="Jet4_rawMass",
    call="basefunctions::getvar<float>({df}, {output}, 3, {input})",
    input=[q.good_jet_collection, nanoAOD.Jet_mass],
    output=[q.jet4_rawMass],
    scopes=["global","vbfhmm"],
)
