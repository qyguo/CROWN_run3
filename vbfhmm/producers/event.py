...
ApplyRoccoRMC = ProducerGroup(
    ...
    subproducers= {
        ...
        "global": [MuonRoccoRRndm, ApplyRoccoRMC_1, ApplyRoccoRMC_2],
    }
)
########################
...
applyMuonScaReData_Err = ProducerGroup(
    name="applyMuonScaReData_Err",
    call=None,
    input=None,
    output=None,
    #scopes=["global","gghmm","vbfhmm","e2m","m2m","eemm","nnmm","fjmm"],
...
applyMuonScaReData_reco = ProducerGroup(
    name="applyMuonScaReData_reco",
    call=None,
    input=None,
    output=None,
    #scopes=["global","gghmm","vbfhmm","e2m","m2m","eemm","nnmm","fjmm"],
...
applyMuonScaReMC_reco = ProducerGroup(
    name="applyMuonScaReMC_reco",
    call=None,
    input=None,
    output=None,
    #scopes=["global","gghmm","vbfhmm","e2m","m2m","eemm","nnmm","fjmm"],
...
mumuH_dR = Producer(
    ...
    output=[q.mumuH_dR],
    scopes=["global","gghmm","vbfhmm","e2m","m2m","eemm","mmmm","nnmm","fjmm"],
)
### e2m channel 
...
FilterFlagLepChargeSum = Producer(
    ...
    output=None,
    scopes=["global","gghmm","vbfhmm","e2m","m2m","eemm","mmmm","nnmm","fjmm","nnmm_dycontrol","nnmm_topcontrol"],
)
...
mu1_mu2_dphi = Producer(
    ...
    scopes=["global","gghmm","vbfhmm","e2m","m2m","nnmm","fjmm"],
)
