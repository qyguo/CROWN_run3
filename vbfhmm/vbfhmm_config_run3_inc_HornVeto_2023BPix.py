...
from .producers import jet_jer as jet_jer
from .producers import jet_jes_2023BPix as jet_jes_2023BPix
...
def build_config(
            ...
            "muon_RoccoR_files": EraModifier(
                {
                    ...
                    "2023BPix": "data/RoccoR_files/2023_Summer23BPix.json",
                }
            ),
        }
    )
            ...
            "muon_sf_file": EraModifier(
                {
                    ...
                    "2022": "data/jsonpog-integration/POG/MUO/2022_Summer22/muon_Z.json.gz", #BCD, 2022
                    "2022EE": "data/jsonpog-integration/POG/MUO/2022_Summer22EE/muon_Z.json.gz", #EFG, 2022EE
                    "2023": "data/jsonpog-integration/POG/MUO/2023_Summer23/muon_Z.json.gz", #BCD, 2022
                    "2023BPix": "data/jsonpog-integration/POG/MUO/2023_Summer23BPix/muon_Z.json.gz", #EFG, 2022EE
                    ######!!!!!!!!!!!
                }
            ),
    ...
    configuration.add_config_parameters(
        "global",
        {
            "min_jet_pt": 25, # for uncertainty change 25->20 by jiahua
            "max_jet_eta": 4.7, # vh
            ...
            "jet_jec_era_algo": EraModifier(
                    {
                        "2022": '"2022_AK4PFPuppi"',
                        "2022EE": '"2022EE_AK4PFPuppi"',
                        "2023": '"2023_AK4PFPuppi"',
                        "2023BPix": '"2023BPix_AK4PFPuppi"',
                    }
            ),
            ...
            "fatjet_jes_tag": EraModifier(
                {
                    ...
                    "2022EE": '"Summer22EE_22Sep2023_V3_MC"',
                    "2023": '"Summer23Prompt23_V2_MC"',
                    "2023BPix": '"Summer23BPixPrompt23_V2_MC"',
                }
            ),
    ...
    configuration.add_producers(
        ...
        [
            ...
            jet_jer.JetEnergyCorrection_2022_jerUp,
            jet_jer.JetEnergyCorrection_2022_jerDown,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesFlavorQCDUp,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesFlavorQCDDown,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesRelativeBalUp,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesRelativeBalDown,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesHFUp,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesHFDown,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesBBEC1Up,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesBBEC1Down,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesEC2Up,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesEC2Down,  
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesAbsoluteUp,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesAbsoluteDown,          
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesBBEC1_eraUp,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesBBEC1_eraDown,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesRelativeSample_eraUp,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesRelativeSample_eraDown,      
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesEC2_eraUp,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesEC2_eraDown,   
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesHF_eraUp,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesHF_eraDown,       
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesAbsolute_eraUp,
            # jet_jes_2023BPix.JetEnergyCorrection_2022_jesAbsolute_eraDown,                    
        ],
    )
    configuration.add_producers(
        "vbfhmm",
        [
            ...
            jets.Jet2_QGdiscriminator,#qgl

            jet_jer.LVJet1_jerUp,
            jet_jer.LVJet2_jerUp,
            jet_jer.jet1_pt_jerUp,
            jet_jer.jet1_mass_jerUp,
            jet_jer.jet1_eta_jerUp,
            jet_jer.jet1_phi_jerUp,
            jet_jer.jet2_pt_jerUp,
            jet_jer.jet2_mass_jerUp,
            jet_jer.jet2_eta_jerUp,
            jet_jer.jet2_phi_jerUp,

            jet_jer.LVJet1_jerDown,
            jet_jer.LVJet2_jerDown,
            jet_jer.jet1_pt_jerDown,
            jet_jer.jet1_mass_jerDown,
            jet_jer.jet1_eta_jerDown,
            jet_jer.jet1_phi_jerDown,
            jet_jer.jet2_pt_jerDown,
            jet_jer.jet2_mass_jerDown,
            jet_jer.jet2_eta_jerDown,
            jet_jer.jet2_phi_jerDown,

            # jet_jes_2023BPix.LVJet1_jesFlavorQCDUp,
            # jet_jes_2023BPix.LVJet2_jesFlavorQCDUp,
            # jet_jes_2023BPix.jet1_pt_jesFlavorQCDUp,
            # jet_jes_2023BPix.jet1_mass_jesFlavorQCDUp,
            # jet_jes_2023BPix.jet2_pt_jesFlavorQCDUp,
            # jet_jes_2023BPix.jet2_mass_jesFlavorQCDUp,

            # jet_jes_2023BPix.LVJet1_jesFlavorQCDDown,
            # jet_jes_2023BPix.LVJet2_jesFlavorQCDDown,
            # jet_jes_2023BPix.jet1_pt_jesFlavorQCDDown,
            # jet_jes_2023BPix.jet1_mass_jesFlavorQCDDown,
            # jet_jes_2023BPix.jet2_pt_jesFlavorQCDDown,
            # jet_jes_2023BPix.jet2_mass_jesFlavorQCDDown,

            # jet_jes_2023BPix.LVJet1_jesRelativeBalUp,
            # jet_jes_2023BPix.LVJet2_jesRelativeBalUp,
            # jet_jes_2023BPix.jet1_pt_jesRelativeBalUp,
            # jet_jes_2023BPix.jet1_mass_jesRelativeBalUp,
            # jet_jes_2023BPix.jet2_pt_jesRelativeBalUp,
            # jet_jes_2023BPix.jet2_mass_jesRelativeBalUp,

            # jet_jes_2023BPix.LVJet1_jesRelativeBalDown,
            # jet_jes_2023BPix.LVJet2_jesRelativeBalDown,
            # jet_jes_2023BPix.jet1_pt_jesRelativeBalDown,
            # jet_jes_2023BPix.jet1_mass_jesRelativeBalDown,
            # jet_jes_2023BPix.jet2_pt_jesRelativeBalDown,
            # jet_jes_2023BPix.jet2_mass_jesRelativeBalDown,

            # jet_jes_2023BPix.LVJet1_jesHFUp,
            # jet_jes_2023BPix.LVJet2_jesHFUp,
            # jet_jes_2023BPix.jet1_pt_jesHFUp,
            # jet_jes_2023BPix.jet1_mass_jesHFUp,
            # jet_jes_2023BPix.jet2_pt_jesHFUp,
            # jet_jes_2023BPix.jet2_mass_jesHFUp,

            # jet_jes_2023BPix.LVJet1_jesHFDown,
            # jet_jes_2023BPix.LVJet2_jesHFDown,
            # jet_jes_2023BPix.jet1_pt_jesHFDown,
            # jet_jes_2023BPix.jet1_mass_jesHFDown,
            # jet_jes_2023BPix.jet2_pt_jesHFDown,
            # jet_jes_2023BPix.jet2_mass_jesHFDown,

            # jet_jes_2023BPix.LVJet1_jesBBEC1Up,
            # jet_jes_2023BPix.LVJet2_jesBBEC1Up,
            # jet_jes_2023BPix.jet1_pt_jesBBEC1Up,
            # jet_jes_2023BPix.jet1_mass_jesBBEC1Up,
            # jet_jes_2023BPix.jet2_pt_jesBBEC1Up,
            # jet_jes_2023BPix.jet2_mass_jesBBEC1Up,

            # jet_jes_2023BPix.LVJet1_jesBBEC1Down,
            # jet_jes_2023BPix.LVJet2_jesBBEC1Down,
            # jet_jes_2023BPix.jet1_pt_jesBBEC1Down,
            # jet_jes_2023BPix.jet1_mass_jesBBEC1Down,
            # jet_jes_2023BPix.jet2_pt_jesBBEC1Down,
            # jet_jes_2023BPix.jet2_mass_jesBBEC1Down,

            # jet_jes_2023BPix.LVJet1_jesEC2Up,
            # jet_jes_2023BPix.LVJet2_jesEC2Up,
            # jet_jes_2023BPix.jet1_pt_jesEC2Up,
            # jet_jes_2023BPix.jet1_mass_jesEC2Up,
            # jet_jes_2023BPix.jet2_pt_jesEC2Up,
            # jet_jes_2023BPix.jet2_mass_jesEC2Up,

            # jet_jes_2023BPix.LVJet1_jesEC2Down,
            # jet_jes_2023BPix.LVJet2_jesEC2Down,
            # jet_jes_2023BPix.jet1_pt_jesEC2Down,
            # jet_jes_2023BPix.jet1_mass_jesEC2Down,
            # jet_jes_2023BPix.jet2_pt_jesEC2Down,
            # jet_jes_2023BPix.jet2_mass_jesEC2Down,

            # jet_jes_2023BPix.LVJet1_jesAbsoluteUp,
            # jet_jes_2023BPix.LVJet2_jesAbsoluteUp,
            # jet_jes_2023BPix.jet1_pt_jesAbsoluteUp,
            # jet_jes_2023BPix.jet1_mass_jesAbsoluteUp,
            # jet_jes_2023BPix.jet2_pt_jesAbsoluteUp,
            # jet_jes_2023BPix.jet2_mass_jesAbsoluteUp,

            # jet_jes_2023BPix.LVJet1_jesAbsoluteDown,
            # jet_jes_2023BPix.LVJet2_jesAbsoluteDown,
            # jet_jes_2023BPix.jet1_pt_jesAbsoluteDown,
            # jet_jes_2023BPix.jet1_mass_jesAbsoluteDown,
            # jet_jes_2023BPix.jet2_pt_jesAbsoluteDown,
            # jet_jes_2023BPix.jet2_mass_jesAbsoluteDown,

            # jet_jes_2023BPix.LVJet1_jesBBEC1_eraUp,
            # jet_jes_2023BPix.LVJet2_jesBBEC1_eraUp,
            # jet_jes_2023BPix.jet1_pt_jesBBEC1_eraUp,
            # jet_jes_2023BPix.jet1_mass_jesBBEC1_eraUp,
            # jet_jes_2023BPix.jet2_pt_jesBBEC1_eraUp,
            # jet_jes_2023BPix.jet2_mass_jesBBEC1_eraUp,

            # jet_jes_2023BPix.LVJet1_jesBBEC1_eraDown,
            # jet_jes_2023BPix.LVJet2_jesBBEC1_eraDown,
            # jet_jes_2023BPix.jet1_pt_jesBBEC1_eraDown,
            # jet_jes_2023BPix.jet1_mass_jesBBEC1_eraDown,
            # jet_jes_2023BPix.jet2_pt_jesBBEC1_eraDown,
            # jet_jes_2023BPix.jet2_mass_jesBBEC1_eraDown,

            # jet_jes_2023BPix.LVJet1_jesRelativeSample_eraUp,
            # jet_jes_2023BPix.LVJet2_jesRelativeSample_eraUp,
            # jet_jes_2023BPix.jet1_pt_jesRelativeSample_eraUp,
            # jet_jes_2023BPix.jet1_mass_jesRelativeSample_eraUp,
            # jet_jes_2023BPix.jet2_pt_jesRelativeSample_eraUp,
            # jet_jes_2023BPix.jet2_mass_jesRelativeSample_eraUp,

            # jet_jes_2023BPix.LVJet1_jesRelativeSample_eraDown,
            # jet_jes_2023BPix.LVJet2_jesRelativeSample_eraDown,
            # jet_jes_2023BPix.jet1_pt_jesRelativeSample_eraDown,
            # jet_jes_2023BPix.jet1_mass_jesRelativeSample_eraDown,
            # jet_jes_2023BPix.jet2_pt_jesRelativeSample_eraDown,
            # jet_jes_2023BPix.jet2_mass_jesRelativeSample_eraDown,            
            # jet_jes_2023BPix.LVJet1_jesEC2_eraUp,
            # jet_jes_2023BPix.LVJet2_jesEC2_eraUp,
            # jet_jes_2023BPix.jet1_pt_jesEC2_eraUp,
            # jet_jes_2023BPix.jet1_mass_jesEC2_eraUp,
            # jet_jes_2023BPix.jet2_pt_jesEC2_eraUp,
            # jet_jes_2023BPix.jet2_mass_jesEC2_eraUp,

            # jet_jes_2023BPix.LVJet1_jesEC2_eraDown,
            # jet_jes_2023BPix.LVJet2_jesEC2_eraDown,
            # jet_jes_2023BPix.jet1_pt_jesEC2_eraDown,
            # jet_jes_2023BPix.jet1_mass_jesEC2_eraDown,
            # jet_jes_2023BPix.jet2_pt_jesEC2_eraDown,
            # jet_jes_2023BPix.jet2_mass_jesEC2_eraDown,

            # jet_jes_2023BPix.LVJet1_jesHF_eraUp,
            # jet_jes_2023BPix.LVJet2_jesHF_eraUp,
            # jet_jes_2023BPix.jet1_pt_jesHF_eraUp,
            # jet_jes_2023BPix.jet1_mass_jesHF_eraUp,
            # jet_jes_2023BPix.jet2_pt_jesHF_eraUp,
            # jet_jes_2023BPix.jet2_mass_jesHF_eraUp,

            # jet_jes_2023BPix.LVJet1_jesHF_eraDown,
            # jet_jes_2023BPix.LVJet2_jesHF_eraDown,
            # jet_jes_2023BPix.jet1_pt_jesHF_eraDown,
            # jet_jes_2023BPix.jet1_mass_jesHF_eraDown,
            # jet_jes_2023BPix.jet2_pt_jesHF_eraDown,
            # jet_jes_2023BPix.jet2_mass_jesHF_eraDown,

            # jet_jes_2023BPix.LVJet1_jesAbsolute_eraUp,
            # jet_jes_2023BPix.LVJet2_jesAbsolute_eraUp,
            # jet_jes_2023BPix.jet1_pt_jesAbsolute_eraUp,
            # jet_jes_2023BPix.jet1_mass_jesAbsolute_eraUp,
            # jet_jes_2023BPix.jet2_pt_jesAbsolute_eraUp,
            # jet_jes_2023BPix.jet2_mass_jesAbsolute_eraUp,

            # jet_jes_2023BPix.LVJet1_jesAbsolute_eraDown,
            # jet_jes_2023BPix.LVJet2_jesAbsolute_eraDown,
            # jet_jes_2023BPix.jet1_pt_jesAbsolute_eraDown,
            # jet_jes_2023BPix.jet1_mass_jesAbsolute_eraDown,
            # jet_jes_2023BPix.jet2_pt_jesAbsolute_eraDown,
            # jet_jes_2023BPix.jet2_mass_jesAbsolute_eraDown,            
            # flag cut
            ...
            scalefactors.MuonIDIso_SF_vbfhmm_noYear_systup,
            scalefactors.MuonIDIso_SF_vbfhmm_noYear_systdown,
...
#
    ...
    configuration.add_outputs(
        ...
        [
            ...
            q.dijet_mass,
            q.dijet_eta,
            q.jet1_btagDeepFlavQG,
            q.jet2_btagDeepFlavQG,#qgl
            #q.btag_weight,
            ...
            # q.jet1_pt_jesFlavorQCDUp,
            # q.jet1_mass_jesFlavorQCDUp,
            # q.jet2_pt_jesFlavorQCDUp,
            # q.jet2_mass_jesFlavorQCDUp,

            # q.jet1_pt_jesFlavorQCDDown,
            # q.jet1_mass_jesFlavorQCDDown,
            # q.jet2_pt_jesFlavorQCDDown,
            # q.jet2_mass_jesFlavorQCDDown,
            ...
            # q.jet1_pt_jesRelativeBalUp,
            # q.jet1_mass_jesRelativeBalUp,
            # q.jet2_pt_jesRelativeBalUp,
            # q.jet2_mass_jesRelativeBalUp,

            # q.jet1_pt_jesRelativeBalDown,
            # q.jet1_mass_jesRelativeBalDown,
            # q.jet2_pt_jesRelativeBalDown,
            # q.jet2_mass_jesRelativeBalDown,
            ...
            # q.jet1_pt_jesHFDown,
            # q.jet1_mass_jesHFDown,
            # q.jet2_pt_jesHFDown,
            # q.jet2_mass_jesHFDown,

            # q.jet1_pt_jesBBEC1Up,
            # q.jet1_mass_jesBBEC1Up,
            # q.jet2_pt_jesBBEC1Up,
            # q.jet2_mass_jesBBEC1Up,

            # q.jet1_pt_jesBBEC1Down,
            # q.jet1_mass_jesBBEC1Down,
            # q.jet2_pt_jesBBEC1Down,
            # q.jet2_mass_jesBBEC1Down,            

            # q.jet1_pt_jesEC2Up,
            # q.jet1_mass_jesEC2Up,
            # q.jet2_pt_jesEC2Up,
            # q.jet2_mass_jesEC2Up,

            # q.jet1_pt_jesEC2Down,
            # q.jet1_mass_jesEC2Down,
            # q.jet2_pt_jesEC2Down,
            # q.jet2_mass_jesEC2Down,

            # q.jet1_pt_jesAbsoluteUp,
            # q.jet1_mass_jesAbsoluteUp,
            # q.jet2_pt_jesAbsoluteUp,
            # q.jet2_mass_jesAbsoluteUp,

            # q.jet1_pt_jesAbsoluteDown,
            # q.jet1_mass_jesAbsoluteDown,
            # q.jet2_pt_jesAbsoluteDown,
            # q.jet2_mass_jesAbsoluteDown,      

            # q.jet1_pt_jesBBEC1_eraUp,
            # q.jet1_mass_jesBBEC1_eraUp,
            # q.jet2_pt_jesBBEC1_eraUp,
            # q.jet2_mass_jesBBEC1_eraUp,

            # q.jet1_pt_jesBBEC1_eraDown,
            # q.jet1_mass_jesBBEC1_eraDown,
            # q.jet2_pt_jesBBEC1_eraDown,
            # q.jet2_mass_jesBBEC1_eraDown,  

            # q.jet1_pt_jesRelativeSample_eraUp,
            # q.jet1_mass_jesRelativeSample_eraUp,
            # q.jet2_pt_jesRelativeSample_eraUp,
            # q.jet2_mass_jesRelativeSample_eraUp,

            # q.jet1_pt_jesRelativeSample_eraDown,
            # q.jet1_mass_jesRelativeSample_eraDown,
            # q.jet2_pt_jesRelativeSample_eraDown,
            # q.jet2_mass_jesRelativeSample_eraDown,   

            # q.jet1_pt_jesEC2_eraUp,
            # q.jet1_mass_jesEC2_eraUp,
            # q.jet2_pt_jesEC2_eraUp,
            # q.jet2_mass_jesEC2_eraUp,

            # q.jet1_pt_jesEC2_eraDown,
            # q.jet1_mass_jesEC2_eraDown,
            # q.jet2_pt_jesEC2_eraDown,
            # q.jet2_mass_jesEC2_eraDown,

            # q.jet1_pt_jesHF_eraUp,
            # q.jet1_mass_jesHF_eraUp,
            # q.jet2_pt_jesHF_eraUp,
            # q.jet2_mass_jesHF_eraUp,

            # q.jet1_pt_jesHF_eraDown,
            # q.jet1_mass_jesHF_eraDown,
            # q.jet2_pt_jesHF_eraDown,
            # q.jet2_mass_jesHF_eraDown,   
            ...
            q.id_wgt_mu_2,
            q.iso_wgt_mu_2,            
            q.id_wgt_mu_1_systup,
            q.iso_wgt_mu_1_systup,
            q.id_wgt_mu_2_systup,
            q.iso_wgt_mu_2_systup,
            q.id_wgt_mu_1_systdown,
            q.iso_wgt_mu_1_systdown,
            q.id_wgt_mu_2_systdown,
            q.iso_wgt_mu_2_systdown,
            ...
            q.mu1_charge,
            q.mu2_charge,
            q.mu1_nTrackerLayers,
            q.mu2_nTrackerLayers,
            q.pt_rc_1,
            q.pt_rc_2,
            q.BSC_pt_rc_1,
            q.BSC_pt_rc_2,
    ...
    if sample != "data":
        configuration.add_modification_rule(
            "vbfhmm",
            AppendProducer(
                producers=[event.applyMuonScaReData_Err,
                event.applyMuonScaReData,
                event.applyMuonScaReData_reco,],
                samples=sample,
                update_output=False,
            ),
        )
    ...
    configuration.add_modification_rule(
        ...
        RemoveProducer(
            ...
            producers=[event.PUweights,
                       jets.JetEnergyCorrection_2022, 
                       met.BuildGenMetVector,
                        # jet_jer.JetPtCorrection_2022_jerUp,
                        # jet_jer.JetPtCorrection_2022_jerUp_GenMatch,
                        # jet_jer.JetMassCorrection_jerUp,
                        jet_jer.JetEnergyCorrection_2022_jerUp,
                        # jet_jer.JetEnergyCorrection_2022_jerUp_GenMatch,


                        # jet_jer.JetPtCorrection_2022_jerDown,
                        # jet_jer.JetPtCorrection_2022_jerDown_GenMatch,
                        # jet_jer.JetMassCorrection_jerDown,
                        jet_jer.JetEnergyCorrection_2022_jerDown,
                        # jet_jer.JetEnergyCorrection_2022_jerDown_GenMatch,
