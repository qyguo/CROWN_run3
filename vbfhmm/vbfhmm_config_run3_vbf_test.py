...
def build_config(
    ...
    configuration.add_config_parameters(
        ["global","gghmm","e2m","m2m","eemm","mmmm","nnmm","fjmm","nnmm_dycontrol","nnmm_topcontrol"],
        {
...
#########################################
    if sample != "data":
        configuration.add_shift(
            SystematicShift(
                name="jerUp",
                shift_config={"global": {"jet_jer_shift": '"up"'}},
                producers={
                    "global": [
                        jets.JetEnergyCorrection_202223,
                    ]
        ...
        configuration.add_shift(
            SystematicShift(
                name="jerDown",
                shift_config={"global": {"jet_jer_shift":'"down"'}},
                producers={
                    "global": [
                        jets.JetEnergyCorrection_202223,
                    ]
