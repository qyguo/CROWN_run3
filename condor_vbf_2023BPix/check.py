...
def filter_and_format_dy_file(folder_path, dy_file, output_file):
    ...
    for line in dy_lines:
        ...
        # 格式化输出行
        formatted_line = f"./vbfhmm_config_run3_Inc_v4_JetVeto_diboson_2023BPix {folder_path}/{extracted_string}.root root://cms-xrd-global.cern.ch/{processed_line} > {log_path}/{extracted_string}.log 2>&1 \n"
...
dy_file = '/afs/cern.ch/user/j/jiahua/CROWN_run3/condor_vbf_2023BPix/Sample_list/ZZto4L_powheg_23BPix.txt'  # DY.txt 文件路径
folder_path = '/afs/cern.ch/user/j/jiahua/work/MC_2023BPix_inc/MC_2023BPix_vbf/ZZto4L_powheg_23BPix'  # 包含 .root 文件的文件夹路径
log_path = '/afs/cern.ch/user/j/jiahua/work/MC_2023BPix_inc/log/log_ZZto4L_powheg_23BPix'  # 输出未找到条目的文件
output_file = 'top.sub'
