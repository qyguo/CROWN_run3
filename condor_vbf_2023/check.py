...
def filter_and_format_dy_file(folder_path, dy_file, output_file):
    ...
    for line in dy_lines:
        ...
        # 格式化输出行
        formatted_line = f"./vbfhmm_config_run3_Inc_v4_JetVeto_top_2023 {folder_path}/{extracted_string}.root root://cms-xrd-global.cern.ch/{processed_line} > {log_path}/{extracted_string}.log 2>&1 \n"
...
dy_file = '/afs/cern.ch/user/j/jiahua/CROWN_run3/condor_2023/Sample_list/ZZto2L2Q_powheg_23.txt'  # DY.txt 文件路径
folder_path = '/afs/cern.ch/user/j/jiahua/work/MC_2023_inc/MC_2023_vbf/ZZto2L2Q_powheg_23'  # 包含 .root 文件的文件夹路径
log_path = '/afs/cern.ch/user/j/jiahua/work/MC_2023_inc/log/log_ZZto2L2Q_powheg_23'  # 输出未找到条目的文件
output_file = 'resub/ZZto2L2Q_powheg_23.sub'
