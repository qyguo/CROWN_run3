...
resubOr=resub1
DataName=*
config=_run3_vbf_uncertainty_2023
JobID_condor=*
JobID_condor=13092754
...
do
    ...
    ##elif [[ ! $checkmain ]]; then
        ...
        if [[ ${DataOrMC} == true ]]; then
            run_script_tmp=./vbfhmm_config_run3_vbf_uncertainty_data_2023
        else
            run_script_tmp=./vbfhmm_config_run3_vbf_uncertainty_top_2023
        fi
