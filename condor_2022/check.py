...
def filter_and_format_dy_file(folder_path, dy_file, output_file):
    ...
    for line in dy_lines:
        ...
        # 格式化输出行
        formatted_line = f"./vbfhmm_config_run3_Inc_v4_JetVeto_top_2022 {folder_path}/{extracted_string}.root root://cms-xrd-global.cern.ch/{processed_line} > {log_path}/{extracted_string}.log 2>&1 \n"
