...
resubOr=resub2
DataName=*
config=_run3_vbf_test_top_2022
JobID_condor=*
JobID_condor=12769535
...
do
    ...
    ##elif [[ ! $checkmain ]]; then
        ...
        if [[ ${DataOrMC} == true ]]; then
            run_script_tmp=./vbfhmm_config_run3_vbf_test_data_2022
        else
            run_script_tmp=./vbfhmm_config_run3_vbf_test_top_2022
        fi
