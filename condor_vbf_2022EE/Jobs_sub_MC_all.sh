...
#file_path=/afs/cern.ch/user/j/jiahua/CROWN_run3/condor_vbf_2022EE/Sample_list/ewk.txt
file_path=/afs/cern.ch/user/j/jiahua/CROWN_run3/condor_vbf_2022EE/Sample_list/triboson.txt
SamListPath=/afs/cern.ch/user/j/jiahua/CROWN_run3/condor_vbf_2022EE/Sample_list
